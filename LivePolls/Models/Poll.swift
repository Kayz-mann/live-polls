...
struct Poll: Codable, Identifiable, Hashable {
    ...
    init(id: String = UUID().uuidString, createdAt: Date? = nil, updatedAt: Date? = nil, name: String, totalCount: Int, options: [Option], option0: Option, option1: Option, option2: Option? = nil, option3: Option? = nil, lastUpdatedOptionId: String? = nil) {
        self.id = id
